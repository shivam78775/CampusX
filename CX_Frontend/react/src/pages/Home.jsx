  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      try {
        ...
        // Filter out anonymous posts from the home feed
    ...
    const fetchUnreadCounts = async () => {
      if (user) {
        ...
        try {
          ...
          const messageRes = await axios.get('http://localhost:4444/api/v1/notifications/unread-messages', {
            withCredentials: true
          });
          setUnreadMessageCount(messageRes.data.totalUnreadCount);

          // Fetch unread notification count
          const notificationRes = await axios.get('http://localhost:4444/api/v1/notifications/unread-count', {
            withCredentials: true
          });
